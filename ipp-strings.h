...
static ipp_loc_t	ipp_strings[] =
{
  ...
  { "printer-state-reasons.opc-life-over", "OPC at end-of-life" },
  { "printer-state-reasons.opc-life-over", "Optical Photoconductor Life Over" },
  { "printer-state-reasons.opc-near-eol", "OPC almost at end-of-life" },
  { "printer-state-reasons.opc-near-eol", "Optical Photoconductor Near End-of-life" },
  { "printer-state-reasons.other", "Check the printer for errors" },
  { "printer-state-reasons.output-area-almost-full", "Output bin is almost full" },
  { "printer-state-reasons.output-area-full", "Output bin is full" },
  { "printer-state-reasons.output-tray-missing", "Output tray is missing" },
